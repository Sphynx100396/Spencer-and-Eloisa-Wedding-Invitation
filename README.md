...
<head>
  ...
  <title>Spencer & Eloisa — Wedding Invitation</title>
  <meta name="description" content="You're invited! Join us to celebrate our wedding." />
    ...
    *{box-sizing:border-box}
    ...
    body{
      ...
      background:
        ...
        linear-gradient(180deg, #f3ebe3, #e9dfd4);
    ...
    .badge{display:inline-block;padding:6px 12px;border-radius:999px;background:rgba(176,137,104,.15);color:var(--brand);font-weight:600;letter-spacing:.04em}
    .names{font-family:"Playfair Display", serif;font-size:clamp(36px,7vw,64px);line-height:1.05;margin:8px 0 4px;color:var(--ink)}
    .amp{letter-spacing:.04em;color:var(--brand)}
    .subtitle{color:var(--muted);font-size:clamp(14px,2.5vw,16px)}
        ...
        <dl>
          ...
          <dd>
            <ul>
              ...
              <li><strong>Guests:</strong><br>Casual in White or Brown</li>
            </ul>
          </dd>
        </dl>
      </div>
